...
int main(int argc, char** argv)
{
	...
	const bool ram_sort = argc > 2 ? (bool)atoi(argv[3]) : false;
	...
	if(ram_sort){
		...
		compute_table<entry_6, entry_7, tmp_entry_x, RamSort6, RamSort7>(
